...
import {gn, newHTML, setCanvasSize, isTablet, getIdFor, isAndroid, setProps, hitRect, frame, OS} from '../utils/lib';
...
export default class Paint {
    ...
    static open (bkg, md5, sname, cname, cscale, sw, sh) {
        ...
        window[OS].analyticsEvent('paint_editor', 'paint_editor_open');
        if (bkg) {
        ...
        window[OS].analyticsEvent('paint_editor', action, label);
        PaintUndo.buffer = [];
        PaintUndo.index = 0;
        maxZoom = 5;
        minZoom = 1;
    ...
    static close () {
        window[OS].analyticsEvent('paint_editor', 'paint_editor_close');
        saving = true;
    ...
    static rightPalette (div) {
        ...
        Paint.addSidePalette(rightpal, 'filltools',
            (window[OS].camera == '1' && Camera.available) ? ['camera', 'paintbucket'] : ['paintbucket']);
    }
    ...
    */
    ...
    static addToBkgLib (fcn) {
        ...
        window[OS].setmedia(pngBase64, 'png', setBkgRecord);
    ...
    */
    ...
    static addToLib (fcn) {
        ...
        var pngBase64 = dataurl.split(',')[1];
        window[OS].setmedia(pngBase64, 'png', setCostumeRecord);
